...
class TextComponent extends React.Component {
    ...
    render() {
        ...
        else if (this.props.xxLarge) stylesArray.push({ fontSize: Constants.XXLARGE });
        else if (this.props.fullLarge) stylesArray.push({ fontSize: Constants.FULLLARGE });
        ...
        stylesArray.push({
            color: this.props.secondary ? Color.LIGHT_BLACK : this.props.color,
